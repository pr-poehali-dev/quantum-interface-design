...
const expertiseAreas = [
  {
    title: "Столешницы",
    description: "Кухонные и барные столешницы из искусственного камня любой формы и размера. Устойчивы к влаге, жару и механическим повреждениям.",
    icon: "ChefHat",
  },
  {
    title: "Подоконники",
    description:
      "Подоконники, которые не выгорают, не трескаются и легко моются. Идеальная замена пластику или дереву в любом интерьере.",
    icon: "Minus",
  },
  {
    title: "Барные стойки",
