...
export function Hero() {
  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-40 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Салон искусственного камня"}</p>

          <h1
            ref={titleRef}
            className="text-4xl md:text-7xl font-medium text-balance text-center text-white mb-0 tracking-tight leading-[0.9] lg:text-8xl"
          >
            {"Изделия из камня"}
            <br />
            <span className="text-orange-200">{"для интерьера"}</span>
          </h1>
        </div>
      </div>
