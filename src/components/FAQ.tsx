...
const faqs = [
  {
    ...
    answer:
      "Мы работаем с ведущими брендами искусственного камня: Corian, Staron, Samsung Radianz, LG Hi-Macs и другими. Поможем подобрать оптимальный вариант под ваш бюджет и задачи.",
  },
  {
