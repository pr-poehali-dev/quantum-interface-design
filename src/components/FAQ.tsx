...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стандартные изделия — от 5 до 20 рабочих дней после утверждения материалов и контрольных замеров. Срочные заказы возможны при наличии материала на складе. Точные сроки оговариваем при оформлении заказа.",
  },
  {
    question: "Вы делаете замер и монтаж?",
    answer:
      "Да, мы приезжаем на контрольный замер после установки мебели. Затем мы изготавливаем изделие, доставляем и производим монтаж. Вам не нужно ничего организовывать самостоятельно.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, у нас есть специальные условия для дизайнеров, мебельных и строительных компаний. Предоставляем образцы, консультируем по материалам и срокам, обеспечиваем точное исполнение проекта.",
  },
  {
    ...
    <section id="faq" className="py-20 md:py-29">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-medium leading-[1.15] tracking-tight mb-6 text-balance lg:text-7xl">
            Частые вопросы
          </h2>
        </div>
        ...
        <div>
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-border">
              ...
              >
                <p className="text-muted-foreground leading-relaxed pb-6 pr-4 md:pr-12">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
